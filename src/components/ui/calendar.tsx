  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: 'text-foreground-70 rounded-md w-9 font-normal text-[0.8rem]',
        week: 'flex w-full mt-2',
        day: 'h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 rounded-1',
        day_button: cn(
          buttonVariants({ variant: 'link', noShadow: true }),
        ...
        outside:
          'day-outside text-foreground-70 opacity-50 aria-selected:bg-accent/50 aria-selected:text-foreground-70 aria-selected:opacity-30',
        disabled: 'text-foreground-70 opacity-50',
        range_middle:
    ...
    return (
      <Popover modal>
        <PopoverTrigger asChild>
          <button
            className={cn(
              'inline-flex items-center justify-start whitespace-nowrap text-base font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none',
              'w-full px-3 py-2 text-left  h-14 rounded-xl border border-input',
              !value && 'text-foreground-70',
            )}
            ref={buttonRef}
          >
            <CalendarIcon className="mr-4 size-6 shrink-0 opacity-50" />
            {value
              ? (
                  format(
                    value,
...
export { Calendar, DateTimePicker, TimePicker, TimePickerInput };
